...
| Batch / Layer normalization | `02.dl/regularization/regularization` | `02.dl/cnn/resnet`, `transformers` |
| Dropout | `02.dl/regularization/regularization` | `02.dl/mlp/mlp`, `transformers` |
| Skip / residual connections | `02.dl/cnn/resnet` | `05.transformers/architectures/transformer` |
| LR scheduling / warmup | `05.transformers/architectures/transformer` | `02.dl/optimizers/optimizers` |
...
- Non-saturating activations (ReLU/GELU) — `02.dl/mlp`.
- Careful initialization (Xavier/He) — `02.dl/mlp`.
- Gradient **clipping** for explosion — `02.dl/rnn`.
- Gated memory (LSTM/GRU) creating a near-identity path — `02.dl/rnn/lstm`.
- **Residual** connections (identity shortcut, gradient ≈ 1) — `02.dl/cnn/resnet`.
- **Normalization** layers keeping activations well-scaled — `02.dl/regularization`.
